...
class Flow {
  ...
  set name (name) {
    ...
    this.callbacks.onPropUpdated(this, 'name', privates.get(this).name, name)
  ...
  set description (desc) {
    ...
    this.callbacks.onPropUpdated(this, 'description', privates.get(this).description, desc)
  ...
  set owner (user) {
    ...
    this.callbacks.onPropUpdated(this, 'owner', privates.get(this).owner, user)
  ...
  set createDate (date) {
    ...
    this.callbacks.onPropUpdated(this, 'createDate', privates.get(this).createDate, date)
  ...
  set lastModifiedDate (date) {
    ...
    this.callbacks.onPropUpdated(this, 'lastModifiedDate', privates.get(this).lastModifiedDate, date)
  ...
  set lastRunDate (date) {
    ...
    this.callbacks.onPropUpdated(this, 'lastRunDate', privates.get(this).lastRunDate, date)
  ...
  set active (active) {
    ...
    this.callbacks.onPropUpdated(this, 'active', privates.get(this).active, active)
  ...
  set logo (filePath) {
    ...
    this.callbacks.onPropUpdated(this, 'logo', privates.get(this).logo, filePath)
